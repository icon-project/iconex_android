...
//                                return;
        ...
        btnContact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(EtherTransferAcitivtyNew.this, ContactsActivity.class)
        ...
        btnQRcodeScan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EtherTransferAcitivtyNew.this, BarcodeCaptureActivity.class);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SendConfirmDialog dialog = new SendConfirmDialog(EtherTransferAcitivtyNew.this, makeTxInfo());
