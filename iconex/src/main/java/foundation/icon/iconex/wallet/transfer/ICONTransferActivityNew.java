...
public class ICONTransferActivityNew extends AppCompatActivity {
    ...
    private void initView() {
        ...
        appbar.setOnActionClickListener(new CustomActionBar.OnActionClickListener() {
            ...
            public void onClickAction(CustomActionBar.ClickAction action) {
                switch (action) {
                    ...
                    case btnEnd:
                        Toast.makeText(ICONTransferActivityNew.this, "not implement", Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                networkDialog.setOnItemClickListener(new BottomSheetMenuDialog.OnItemClickListener() {
                    ...
                    public void onBasicItem(String item) {
                        ...
                        PreferenceUtil preferenceUtil = new PreferenceUtil(ICONTransferActivityNew.this);
        ...
        btnContact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(ICONTransferActivityNew.this, ContactsActivity.class)
        ...
        btnQRcodeScan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ICONTransferActivityNew.this, BarcodeCaptureActivity.class);
            ...
            getStepCost.enqueue(new Callback<LCResponse>() {
                ...
                public void onResponse(Call<LCResponse> call, Response<LCResponse> response) {
                    if (response.isSuccessful()) {
                        ...
                        ICONTransferActivityNew.this.defaultLimit = new BigInteger(Integer.toString(defaultLimit));
