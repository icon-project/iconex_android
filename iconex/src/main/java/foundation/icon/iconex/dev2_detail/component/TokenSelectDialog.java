...
public class TokenSelectDialog extends BottomSheetDialog implements View.OnClickListener {
    ...
    public TokenSelectDialog(@NonNull Context context, SelectType selected, OnSelectListener listener) {
        super(context);
        mSelected = selected;
