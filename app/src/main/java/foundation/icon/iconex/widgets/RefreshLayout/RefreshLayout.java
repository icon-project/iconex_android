...
public class RefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public View footer;
    @Nullable
    public LoadingHeaderListener mHeaderListener;
...
//        }
    ...
    /**
     * Call this method to add {@link LoadingHeaderListener} ,It's better to make the {@link #header} to impl.
     */
    public void setOnHeaderListener(LoadingHeaderListener mHeaderListener) {
    ...
    public void addHeader(@NonNull View header) {
        this.header = header;
        if (header instanceof LoadingHeaderListener) {
            mHeaderListener = (LoadingHeaderListener) header;
        }
...
//                break;
    ...
    public void measureView(View v) {
        ...
        int h = MeasureSpec.makeMeasureSpec(0,
                MeasureSpec.UNSPECIFIED);
        v.measure(w, h);
        if (v instanceof LoadingHeaderListener && headerHeight == 0) {
    ...
    /**
     * call this method to make {@link #RefreshLayout} know the refresh is over.
    ...
    /**
     * call this method to make {@link #RefreshLayout} know this refresh is over.
     *
